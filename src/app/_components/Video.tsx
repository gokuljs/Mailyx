      ...
      <div className="relative">
        ...
        >
          ...
          <div className="relative aspect-video w-full overflow-hidden bg-gray-900">
            ...
            {/* Fallback background if poster doesn't load */}
            {!isPlaying && (
              <div className="absolute inset-0 -z-10 bg-gradient-to-br from-gray-800 via-gray-900 to-black"></div>
            )}

            {/* Enhanced Poster Overlay - Only show text overlay when not playing */}
            {!isPlaying && (
