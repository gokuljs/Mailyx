...
CREATE UNIQUE INDEX "EmailAddress_accountId_address_key" ON "EmailAddress" USING btree ("accountId" text_ops,"address" text_ops);--> statement-breakpoint
...
CREATE INDEX "_ToEmails_B_index" ON "_ToEmails" USING btree ("B" text_ops);