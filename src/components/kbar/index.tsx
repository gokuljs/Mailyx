    ...
    <>
      <KBarPortal>
        <KBarPositioner className="scrollbar-hide fixed inset-0 z-[99999] bg-black/40 !p-0 backdrop-blur-sm dark:bg-black/60">
          <KBarAnimator className="text-foreground relative !mt-64 w-full !-translate-y-12 overflow-hidden rounded-[0.5rem] border bg-white shadow-lg sm:max-w-[600px] md:max-w-[800px] lg:max-w-[900px] dark:border-gray-950 dark:bg-[hsl(20_14.3%_4.1%)] dark:text-gray-200">
